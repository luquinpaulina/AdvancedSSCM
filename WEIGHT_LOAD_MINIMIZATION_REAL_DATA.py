# THIS PROBLEM IS WEIGHT LOAD MINIMIZATION WITH NAME OF CITIES
...
q = { #demand
    0: 0, # assigned the depot a demand of 0 to bypass errors with constraint 14
    1: 721,
    2: 814,
    3: 620,
    4: 311,
